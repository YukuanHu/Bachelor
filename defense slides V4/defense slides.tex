...
\end{equation}
\begin{rem}
问题\blue{\eqref{original problem matrix form}}的约束非常特殊, 但在最优运输问题中十分普遍.
\end{rem}
\end{frame}
...
\textbf{目的}: 揭示算法的{\color{red}{性质}}、说明算法的{\color{red}{有效性}}和{\color{red}{优越性}}.
\end{frame}
...
\tnewroman{MATLAB}内置函数\texttt{fmincon()}, 调用算法\texttt{'sqp'}求解问题\beq{original problem matrix form 2}和\beq{original problem matrix form 1}, 设置停机准则\texttt{'ConstraintTolerance'}为与\tnewroman ADMM相同的水平.
