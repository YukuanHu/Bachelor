...
\begin{itemize}
\item 讨论人工因子$\alpha,\beta$对算法的影响;
\item 构造测试问题说明算法的有效性;
\item 与现有的求解非凸二次规划算法进行对比.
\end{itemize}
\end{frame}
...
\end{figure}
\begin{center}
	\small\textcolor[rgb]{0,0.25,0.604}{\tnewroman 图 1: }$n=3$, 不同的松弛因子\\\footnotesize 左: 迭代数; 中: 所耗时间; 右: 目标值.
\end{center}
}
...
\end{figure}
\begin{center}
	\small\textcolor[rgb]{0,0.25,0.604}{\tnewroman 图 2: }$n=30$, 不同的松弛因子\\\footnotesize 左: 迭代数; 中: 所耗时间; 右: 目标值.
\end{center}}
\end{frame}
...
\end{figure}
\begin{center}
	\small\textcolor[rgb]{0,0.25,0.604}{\tnewroman 图 3: }$n=30,\beta=10^3$残差陷入循环\\\footnotesize 左: 原始残差; 右: 对偶残差.
\end{center}
}
\end{frame}
...
\end{figure}
\begin{center}
		\small\textcolor[rgb]{0,0.25,0.604}{图 4: }算法\ref{ADMM}和\tnewroman SQP运行时间对比
	\end{center}
